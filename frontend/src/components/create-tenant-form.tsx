    ...
    >
      <div>
        ...
        <input
          ...
          type="text"
          {...register("name")}
          className="w-full rounded-xl border border-slate-300 px-3 py-2.5 text-slate-950 outline-none transition focus:border-cyan-600"
        />
      ...
      <button
        ...
        className="w-full rounded-xl bg-slate-950 px-4 py-2.5 font-medium text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-60"
      >
