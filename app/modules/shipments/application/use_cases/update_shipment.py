...
from app.modules.shipments.domain.enums import ServiceType, WeightUnit
...
class UpdateShipment:
    ...
    async def execute(
        ...
        async with self._unit_of_work as uow:
            ...
            shipment.customer_id = command.customer_id
            shipment.origin_location_id = command.origin_location_id
            shipment.destination_location_id = command.destination_location_id
            shipment.tracking_number = tracking_number
            shipment.reference = reference
            shipment.service_type = command.service_type
            shipment.description = description
            shipment.weight = command.weight
            shipment.weight_unit = command.weight_unit
